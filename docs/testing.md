...
```
python -m pytest tests -q          # full suite (422 tests, ~150 s)
```
...
- pytest → 422 passed (boss habits, shield bubble, terrain phases, sprites/whip/pickup pods, specialists, drum kit and grooves, melodic identity, seamless sector handoff and prefetch included)
